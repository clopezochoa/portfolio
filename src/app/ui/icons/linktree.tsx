...
function Linktree({className, width, height, color, onClick}:{className:string, width:number | string, height:number | string, color: string, onClick?:() => void}) {
  ...
  return (
    <div onClick={onClick} className={className}>
      <svg id="Layer_1" data-name="Layer 1"  style={style} fill={color} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 982">
